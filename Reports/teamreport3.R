...
#pars = sigma^2 (partial sill) and phi (range parameter)
fit.expo.OLS1=variofit(vario1, ini.cov.pars=c(0.05,0.15),
                      weights = 'equal',
...
fit.expo.OLS2=variofit(vario2, ini.cov.pars=c(0.08,0.58),
                       weights = 'equal',
                       cov.model = "exponential") ## try many other models 
fit.expo.OLS2
#variofit: model parameters estimated by OLS (ordinary least squares):
...
fit.expo.OLS3=variofit(vario3, ini.cov.pars=c(0.08,0.2),
                       weights = 'equal',
                       cov.model = "exponential") ## try many other models 
fit.expo.OLS3


fit.expo.OLS4=variofit(vario4, ini.cov.pars=c(0.03,0.1),
                       weights = 'equal',
                       cov.model = "exponential") ## try many other models 
fit.expo.OLS4
